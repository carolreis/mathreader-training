...
main_dir = treatment_dir + 'datasets/asteriscos_source/ast/'
...
helpers.debug("Asteriscos all")

def segmenta_asteriscos():
    images = []
...
def prepara_dataset(images):
    ...
    np.savez(treatment_dir + treated_dir + "ast_training_images", training_images)
    np.savez(treatment_dir + treated_dir + "ast_training_labels", training_labels)

    np.savez(treatment_dir + treated_dir + "ast_testing_images", testing_images)
    np.savez(treatment_dir + treated_dir + "ast_testing_labels", testing_labels)
    
images = segmenta_asteriscos()
helpers.debug('Total:')
